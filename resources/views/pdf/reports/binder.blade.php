        ...
        <div class="@if(!$loop->last) page-break @endif">
                ...
                <table style="border: none; margin-bottom: 0;">
                    <tr style="border: none;">
                        <td style="border: none; width: 70%;">
                            <h2 style="margin: 0;">LAPORAN BINDER (10 MJ/Halaman)</h2>
                            <p style="margin: 0;">Mandor Jaya</p>
                        </td>
                        <td style="border: none; text-align: right;">
                            <p style="margin: 0;">Periode: {{ $date_from ? \Carbon\Carbon::parse($date_from)->format('d/m/Y') : 'Awal' }} - {{ $date_to ? \Carbon\Carbon::parse($date_to)->format('d/m/Y') : 'Akhir' }}</p>
            ...
            @foreach($chunk as $sale)
                <div class="sale-wrapper">
                    <!-- Sale Header Line -->
                    <div style="background-color: #ddd; padding: 5px; border: 1px solid #000; border-bottom: none; font-weight: bold;">
                        NO: {{ $sale->sale_number }} | 
                    ...
                    <table style="width: 100%; margin-bottom: 10px;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">{{ number_format($detail->quantity, 0, ',', '.') }} {{ $detail->itemUom->uom->name ?? '' }}</td>
