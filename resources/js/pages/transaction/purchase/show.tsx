        ...
        router.post(
            ...
            {},
            {
                ...
                onError: (errors: Record<string, string>) => {
                    const message = errors.error || errors.msg || errors.message || 'Gagal konfirmasi pembelian';
                    toast.error(message);
                    closeConfirmModal();
                },
            },
            ...
            <AppLayout breadcrumbs={breadcrumbs}>
                ...
                <div className="mb-2 flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                        ...
                        {(purchase.remaining_amount ?? 0) > 0 && (purchase.remaining_amount ?? 0) < 100000 && (
                            <Button
                ...
                <div className="flex w-full justify-end gap-2">
                    <DotMatrixPrintButton
                        ...
                        onSuccess={() => {
                            router.post(`/purchases/${purchase.id}/mark-printed`, {}, { preserveScroll: true });
                        }}
                    />
                    <Button
                        className="btn-primary"
                    ...
                    <Card className="content">
                        ...
                        <CardContent className="space-y-2">
                            ...
                            <div className="flex justify-between">
                                ...
                                <span className="font-medium">
                                    <Badge
                                        variant={purchase.is_printed ? 'success' : 'secondary'}
                                        className={cn(
                                            purchase.is_printed
                                                ? 'badge-blue-light'
                                    ...
                                    >
                                        {purchase.is_printed ? 'Sudah Diprint' : 'Belum Diprint'}
                                    </Badge>
                                </span>
                            </div>
                            {purchase.due_date && (
                            ...
                            <div className="flex justify-between">
                                ...
                                <span className="font-medium">
                                    {purchase.created_at ? new Date(purchase.created_at).toLocaleString('id-ID', { day: '2-digit', month: 'short', year: 'numeric', hour: '2-digit', minute: '2-digit' }) : '-'}
                                </span>
                            </div>
                            <div className="flex justify-between">
                                <span className="text-muted-foreground">
                            ...
                            <div className="flex justify-between">
                                ...
                                <span className="font-medium">
                                    {purchase.updated_at ? new Date(purchase.updated_at).toLocaleString('id-ID', { day: '2-digit', month: 'short', year: 'numeric', hour: '2-digit', minute: '2-digit' }) : '-'}
                                </span>
                            </div>
                        </CardContent>
                    </Card>
