...
import customers, { index } from '@/routes/customers';
...
const CustomerImport = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        post(customers.import.store().url, {
            forceFormData: true,
            onSuccess: () => {
    ...
    const downloadTemplate = () => {
        window.location.href = '/customers/import/template';
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Import Customer" />
                    ...
                    <CardContent className="space-y-4">
                        <div>
                            ...
                            <ul className="list-inside list-disc space-y-1 text-sm">
                                <li>
                                    <strong>name</strong> (wajib) - Nama customer
                                </li>
                                <li>
