...
const breadcrumbs = [
    ...
    { title: 'Laporan Biaya', href: '#' },
];

const indexRoute = () => ({ url: '/reports/expenses' });
...
export default function ExpenseReportIndex({
    ...
    const handlePrint = () => {
        ...
        window.open(`/reports/expenses/print?${queryParams}`, '_blank');
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <Card className="content">
                <CardHeader>
                    <CardTitle>Rincian Biaya per Akun</CardTitle>
                        ...
                        <TableLayout
                            ...
                            renderRow={(item) => (
                                <>
                                    ...
                                    <TableCell className="flex w-full min-w-[120px] items-center justify-end text-right text-red-600">
