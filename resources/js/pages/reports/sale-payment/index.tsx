...
export default function SalePaymentReportIndex({
    ...
    const handleFilter = () => {
        router.get('/reports/sale-payment', filters, {
            preserveState: true,
            preserveScroll: true,
        });
    };
                        ...
                        <div className="flex items-end gap-2">
                            ...
                            <Button
                                onClick={() => {
                                    ...
                                    window.open(`/reports/sale-payment/print?${params.toString()}`, '_blank');
                                }}
                                variant="outline"
                                className="flex-1"
                            >
                        ...
                        <Table>
                            <TableHeader>
                                <TableRow>
                                    ...
                                    <TableHead className="text-right">Jumlah Penjualan</TableHead>
                                    <TableHead className="text-right">Total</TableHead>
                                </TableRow>
                            </TableHeader>
                            <TableBody>
                                {salePayments.length > 0 ? (
                                    salePayments.map((payment) => (
                                        <TableRow key={payment.id}>
                                            ...
                                            <TableCell className="text-right">{payment.sales_count}</TableCell>
