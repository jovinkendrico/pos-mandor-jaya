                                ...
                                {saleReturns.length > 0 ? (
                                    saleReturns.map((returnItem) => (
                                        <TableRow key={returnItem.id}>
                                            ...
                                            <TableCell className="font-mono">{returnItem.sale_number}</TableCell>
                                            ...
                                            <TableCell>{returnItem.refund_method === 'reduce_receivable' ? 'Kurangi Piutang' : 'Cash Refund'}</TableCell>
