                                        ...
                                        <TableRow key={index}>
                                            ...
                                            <TableCell>
                                                <Input
                                                    type="text"
                                                    value={
                                                        formatDiscountDisplay(detail.discount1_percent || 0)
                                                    }
                                                    onChange={(e) => {
                                                        const value =
                                                            formatDiscount(
                                            ...
                                            <TableCell>
                                                <Input
                                                    type="text"
                                                    value={
                                                        formatDiscountDisplay(detail.discount2_percent || 0)
                                                    }
                                                    onChange={(e) => {
                                                        const value =
                                                            formatDiscount(
                                            ...
                                            <TableCell>
                                                <Input
                                                    type="text"
                                                    value={
                                                        formatDiscountDisplay(detail.discount3_percent || 0)
                                                    }
                                                    onChange={(e) => {
                                                        const value =
                                                            formatDiscount(
                                            ...
                                            <TableCell>
                                                <Input
                                                    type="text"
                                                    value={
                                                        formatDiscountDisplay(detail.discount4_percent || 0)
                                                    }
                                                    onChange={(e) => {
                                                        const value =
                                                            formatDiscount(
                    ...
                    <CardContent className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <Input
                                id="ppn_percent"
                                type="text"
                                value={formatDiscountDisplay(dataPurchase.ppn_percent || 0)}
                                onChange={(e) => {
