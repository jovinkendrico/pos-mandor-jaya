...
class SaleByItemReportController extends Controller
{
    ...
    public function index(Request $request): Response
    {
        ...
        $summary = [
            ...
            'total_transactions' => $itemSales->sum('transaction_count'),
            'total_revenue' => $itemSales->sum('total_revenue'),
            'total_cost' => $itemSales->sum('total_cost'),
        ...
        return Inertia::render('reports/sale-by-item/index', [
            'dateFrom' => $dateFrom,
            'dateTo' => $dateTo,
            'summary' => $summary,
            'itemSales' => $itemSales,
