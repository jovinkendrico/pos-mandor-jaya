...
class ExpenseReportController extends Controller
{
    ...
    public function index(Request $request): Response
    {
        ...
        // Get all expense accounts with their balances
    ...
    public function print(Request $request)
    {
        ...
        $pdf = Pdf::loadView('pdf.reports.expense-report', [
            'title' => 'Laporan Biaya',
            'dateFrom' => $dateFrom,
            'dateTo' => $dateTo,
            'vehicleId' => $vehicleId,
        ...
        return $pdf->download('laporan-biaya-' . $dateFrom . '-to-' . $dateTo . '.pdf');
    }
