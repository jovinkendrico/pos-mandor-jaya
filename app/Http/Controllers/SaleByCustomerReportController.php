...
class SaleByCustomerReportController extends Controller
{
    ...
    /**
     * Print sale by customer report as PDF
     */
    public function print(Request $request)
    {
        try {
            ...
            $pdf = Pdf::loadView('pdf.reports.sale-by-customer', [
            ...
            $filename = 'laporan-penjualan-per-customer-' . $dateFrom . '-to-' . $dateTo . '.pdf';
            return $pdf->download($filename);
        } catch (\Exception $e) {
            Log::error('PDF Print Sale By Customer Report - Exception caught', [
                'error' => $e->getMessage(),
                'file' => $e->getFile(),
                'line' => $e->getLine(),
            ]);
